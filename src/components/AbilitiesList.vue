  ...
  <div class="flex flex-col w-full space-y-3">
    ...
    <div class="flex space-x-2 items-center w-full">
      <template v-if="loading">
        <skeleton-loader v-for="n in 2" v-bind:key="n" class="w-24 h-6 rounded-full" />
      </template>
      <span v-for="ability in abilities" v-else v-bind:key="ability.ability.id" role="ability"
...
defineProps<{ abilities: Ability[]; loading: boolean }>()
</script>
